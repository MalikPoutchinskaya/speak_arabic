...
export class Config {
  ...
  'server.port' = '8081';
  'jhipster.clientApp.name' = 'speak_arabic';
  ...
  'jhipster.mail.from' = 'speak_arabic@localhost';
  'jhipster.swagger.default-include-pattern' = '/api/.*';
  'jhipster.swagger.title' = 'speak_arabic API';
  'jhipster.swagger.description' = 'speak_arabic API documentation';
  ...
  'eureka.instance.appname' = 'speak_arabic';
  'eureka.instance.instanceId' = 'speak_arabic:${random.value}';
  ...
  'cloud.config.name' = 'speak_arabic';
