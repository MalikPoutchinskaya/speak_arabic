  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="speakArabicApp.country.home.createOrEditLabel">Create or edit a Country</h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <AvForm model={isNew ? {} : countryEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                <Label id="flagUrlLabel" for="country-flagUrl">
                  Flag Url
                </Label>
                <AvField id="country-flagUrl" type="text" name="flagUrl" />
              </AvGroup>
